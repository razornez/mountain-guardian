...
const Sidebar = () => {
  ...
  const filteredMountains = mountains.filter((m) => m.name.toLowerCase().includes(searchQuery.toLowerCase()));
      ...
      >
                ...
                <li key={item.href}>
                  <Link
                    ...
                    className={`
                      ...
                      ${isActive ? 'bg-emerald-500/10 text-emerald-500' : 'text-slate-300 hover:bg-slate-800 hover:text-white'}
                    `}
                  >
        ...
        <div className="p-4 border-t border-slate-800">
          <div className="text-xs text-slate-400">
            ...
            <p className="text-emerald-500">Sistem Aktif</p>
          </div>
        </div>
      </aside>
